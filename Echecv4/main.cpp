...
int main() {
    ...
    while (!finPartie) {
        ...
        laPiece1 = laPiece1->listePiece[cellBase.first][cellBase.second];
        ...
        laPiece2 = laPiece2->listePiece[cellArriv.first][cellArriv.second];

        if (!laPiece2->getEnJeu() || laPiece2->getEstBlanc() != joueurBlanc) {
            bool mouvAutorise;
